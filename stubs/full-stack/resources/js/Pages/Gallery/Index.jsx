                ...
                <div style={{ maxWidth: 1240, margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: 40 }}>
                        ...
                        <Text type="secondary" style={{ fontSize: 16, maxWidth: 760, display: 'inline-block' }}>
                            Explore the latest visual content from the site. The layout is rendered as a masonry gallery so mixed image and video formats stay compact and visually balanced.
                        </Text>
                    </div>
